/**
 * 
 * RM4hZBv0dDon443M= -> window._$ss -> _0x29dd83[_$UH[31]]()
 */
...
function _0x35f5f2(_0x243853) {
  var _0x139b8b;
  var _0xa791a1 = [];
  for (_0xa791a1[(_0x243853["length"] >> 2) - 1] = undefined, _0x139b8b = 0; _0x139b8b < _0xa791a1["length"]; _0x139b8b += 1) {
...
function _0x11a7a2(_0x193f00, _0x1cfe89) {
  ...
  try {
    // var _0x42fb36 = _0x4e96b4["XMLHttpRequest"]["prototype"].DONE * 4;
    var _0x42fb36 = 16;
  } catch (_0x1b1b35) {
    var _0x42fb36 = 16;
  }
...
function _0x12b47d(_0x149183) {
  ...
  for (_0xabbcb3 = 0; _0xabbcb3 < _0x4fce58; _0xabbcb3 += 8) {
    _0x1145c3 += _0x30bc70["fromCharCode"](_0x149183[_0xabbcb3 >> 5] >>> _0xabbcb3 % 32 & 255);
  }
  return _0x1145c3;
}
...
// _0x4e96b4._$tT = -172015004;
// _0x4e96b4._$tT = -678335;
_0x4e96b4._$tT = -660478335; _0x4e96b4._$Jy = -405537848; _0x4e96b4._$6_ = -389564586;


console.log(_0x474032("1777197960564"));

function rm4Encrypt(plaintext, key) {
...
function getParamers() {
    ...
    let is = new Date().valueOf().toString();
    pr.push(_0x474032(is))

    // test
    // is = "1777177819807";
    // pr = "031aa14a1a0ac9acea4b909c3cf474fc,860145b351a76733766fa3136aac6101,36af0fff2e97de78719868b7d35fd10c,fde6dffd8ca830e3514596d4e17ed4ca,5c042e39ad5890ec031ab027c13c92cc";
    // test

    const cookie_rm4 = rm4Encrypt(pr.toString(), btoa(is.toString()).slice(0, 16));
    return {
        "cookie_m": _0x474032(is),
