...
console.log(
  "===== 1. Object.getOwnPropertyDescriptor 【只触发紫色描述符日志】 =====",
);
...
console.log(
  "===== 1.1 Object.getOwnPropertyDescriptor 不存在的属性 【只触发紫色描述符日志】 =====",
);
Object.getOwnPropertyDescriptor(testObj, "un_exist_property");
console.log("\n");

console.log(
  "===== 2. Reflect.getOwnPropertyDescriptor 【只触发紫色描述符日志】 =====",
);
...
console.log(
  "===== 4. Object.getOwnPropertyDescriptors 批量触发描述符检测 =====",
);
...
console.log(
  "===== 7. for...in 循环：只会触发getOwnPropertyDescriptor 、不会触发 has =====",
);
...
console.log(
  "===== 8.2 Object.values / Object.entries：先触发 getOwnPropertyDescriptor 再get =====",
);
